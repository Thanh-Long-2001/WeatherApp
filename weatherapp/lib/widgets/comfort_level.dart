                ...
                child: SleekCircularSlider(
                  ...
                  innerWidget: (double value) {
                    return Center(
                      child: Column(
                        ...
                        children: [
                          Text(
                            "${weatherDataCurrent.current.humidity!.toInt()}%", // Định dạng giá trị thành số nguyên
                          ...
                          const Text(
                            "Humidity", // Định dạng giá trị thành số nguyên
                            style: TextStyle(
                              fontSize: 20,
                              color: Colors.white,
                            ),
                  ...
                  appearance: CircularSliderAppearance(
                      ...
                      customColors: CustomSliderColors(
                          ...
                          progressBarColors: [
                            const Color.fromARGB(255, 226, 240, 29),
                            const Color.fromARGB(255, 243, 242, 178),
                          ])),
                ),
              ),
              Row(
